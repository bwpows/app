<template>
  <div class="entry-content">
    ...
    <p>3. 您不得以创建相同或竞争服务为目的使用本产品；</p>
    <p>
      4.
      除非法律明文规定，否则您不得对本产品的任何部分以任何形式或方法进行生产、复制、发行、出售、下载或显示等；
    </p>
    <p>5. 您不得删除或破坏包含在本产品中的任何版权声明或其他所有权标记。</p>
    <h3 class="mb-2">费用</h3>
    <p>
